...
func (s *scprimeAPI) FindAddressBalance(limit int, page int, currency string, addresses []string) (WalletBalance, error) {
	...
	u := fmt.Sprintf("https://api.siacentral.com/v2/scprime/wallet/addresses?%s", v.Encode())
